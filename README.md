...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,tailwind,sass,bootstrap,ts,figma,bash,codepen,figma,react,git,github,vscode,npm,ps,ai,pycharm,pug,vite,webpack,gitlab,sublime,notion,linux,&perline=15)](#)
