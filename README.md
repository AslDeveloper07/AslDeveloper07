...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,tailwind,sass,bootstrap,ts,figma,bash,codepen,react,git,github,vscode,npm,ps,ai,pycharm,pug,vite,sublime,&perline=15)](#)
